...
<div id="header-div">
    <div id="logo-div" style="bgcolor:#000000;">
        <img src="http://admin.jx.com/Public/Images/ecshop_logo.gif" alt="ECSHOP - power for e-commerce" />
    </div>
    <div id="submenu-div">
        <ul>
        ...
        <div id="send_info">
            <a href="javascript:void(0);" target="main-frame" class="fix-submenu"><?php echo session('USERINFO')['username'];?></a>
