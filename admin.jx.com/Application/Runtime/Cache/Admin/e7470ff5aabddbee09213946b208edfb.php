    ...
    <div class="list-div" id="listDiv">
        <table width="100%" cellspacing="1" cellpadding="2" id="list-table">
            ...
            <?php if(is_array($list)): foreach($list as $key=>$val): ?><tr align="center" class="0">
                ...
                <img src="http://admin.jx.com/Public/Images/menu_minus.gif" width="9" height="9" border="0" style="margin-left:0em" />
                <span><a href="javascript:void(0)"><<?php echo ($val["cat_name"]); ?>></a></span>
                </td>
                <td width="15%"><img src="http://admin.jx.com/Public/Images/<?php if($val["is_nav"] == 1): ?>yes.gif<?php else: ?>no.gif<?php endif; ?>"  /></td>
                <td width="15%"><img src="<?php if($val["is_show"] == 1): ?>http://admin.jx.com/Public/Images/yes.gif <?php else: ?> http://admin.jx.com/Public/Images/no.gif<?php endif; ?>" /></td>
